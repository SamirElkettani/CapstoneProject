...
DATABASES = {
    'default': {
        ...
        'HOST': 'database-1.ci0uxhucofcw.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'awscapstonesamirblog' # please enter your s3 bucket name
